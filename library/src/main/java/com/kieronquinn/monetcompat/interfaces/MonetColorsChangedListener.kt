...
interface MonetColorsChangedListener {
     ...
     *  for example
     *  @param monetColors The full [ZcamDynamicColorScheme] generated by Monet to get whatever palettes
     *  you like
     ...
     */
    fun onMonetColorsChanged(monet: MonetCompat, monetColors: ZcamDynamicColorScheme, isInitialChange: Boolean)
}